...
// 20 planets with hex coordinates in a reasonable radius around center (0,0)
...
export class SeedInitialPlanets1732401000000 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    // First, ensure hexes exist for all planets
    for (const planet of PLANET_SEEDS) {
      // Insert hex (ON CONFLICT DO UPDATE to mark as having planet)
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    // Update hexes to mark them as not having planets (but don't delete hexes)
