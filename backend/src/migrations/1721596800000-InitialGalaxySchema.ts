...
export class InitialGalaxySchema1721596800000 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    `);
    await queryRunner.query(
      `CREATE INDEX "idx_planet_market_planet" ON "planet_market" ("planet_id")`,
    );
    await queryRunner.query(
      `CREATE INDEX "idx_planet_market_good" ON "planet_market" ("good_id")`,
    );
    ...
    `);
    await queryRunner.query(
      `CREATE INDEX "idx_player_inventory_ship" ON "player_inventory" ("ship_id")`,
    );
    await queryRunner.query(
      `CREATE INDEX "idx_player_inventory_good" ON "player_inventory" ("good_id")`,
    );
    ...
    `);
    await queryRunner.query(
      `CREATE INDEX "idx_event_effect_event" ON "event_market_effects" ("event_id")`,
    );
    ...
    `);
    await queryRunner.query(
      `CREATE INDEX "idx_travel_log_ship" ON "travel_log" ("ship_id")`,
    );
    await queryRunner.query(
      `CREATE INDEX "idx_travel_log_event" ON "travel_log" ("event_id")`,
    );
    ...
    `);
    await queryRunner.query(
      `CREATE INDEX "idx_reputation_log_user" ON "reputation_log" ("user_id")`,
    );
  }
